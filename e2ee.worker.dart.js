          ...
          switch ($async$goto) {
            ...
            case 15:
              ...
              if (t8 !== B.CryptorError_1)
                ...
                t8 = false;
              if (t8) {
                A.printString("KeyRatcheted: ssrc " + A.S(J.get$synchronizationSource$x(metaData)) + " timestamp " + A.S(t1.get$timestamp(frame)) + " ratchetCount " + A.S(ratchetCount) + "  participantId: " + $async$self.participantId);
